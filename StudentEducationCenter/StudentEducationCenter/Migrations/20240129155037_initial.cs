        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeGroupName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChildrenCourses", x => new { x.ChildId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_ChildrenCourses_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChildrenCourses_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChildrenCourses_CourseId",
                table: "ChildrenCourses",
                column: "CourseId");
